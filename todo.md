...
- [x] Implement periodic supplier evidence access recertification with campaign launch, manager attestation, retain or remove decisions, escalation, closure, and audit events.
- [x] Persist campaigns, certifications, and audit history through an atomic local JSON store.
